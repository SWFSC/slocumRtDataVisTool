...
class gliderData:
    ...
    def getWorkingDirs(self):
        self.data_dir = "/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/data/new_data/" # set directoy path for data
    ...
    def makeFlightPanel(self): # needs to be pointed to a save directory
        ...
        if self.data_dir == "/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/data/processed/":
            plt.savefig(f"/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/images/toSend/{self.glider}_flight_panel_full_time_series.png")
        else:
            plt.savefig(f"/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/images/toSend/{self.glider}_flight_panel_{self.date}.png")
        # plt.show()
    ...
    def makeSciDpPanel(self):
        ...
        if self.data_dir == "/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/data/processed/":
            plt.savefig(f"/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/images/toSend/{self.glider}_depth_profiles_full_time_series.png")
        else:
            plt.savefig(f"/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/images/toSend/{self.glider}_depth_profiles_{self.date}.png")
        # plt.show()
    ...
    def makeSciTSPanel(self):
        ...
        for var in self.sci_vars:
            ...
            if f"{self.glider}_{glider_lon_mean:0.0f}_{glider_lat_mean:0.0f}" in os.listdir("/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/mapPickles/"):
                with open(f"/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/mapPickles/{self.glider}_{glider_lon_mean:0.0f}_{glider_lat_mean:0.0f}", "rb") as fd:
                    map = pickle.load(fd)
            else:
                ...
                with open(f"/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/mapPickles/{self.glider}_{glider_lon_mean:0.0f}_{glider_lat_mean:0.0f}", "wb") as fd:
            ...
            if f"{self.glider}_{glider_lon_mean:0.0f}_{glider_lat_mean:0.0f}_inset" in os.listdir("/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/mapPickles/"):
                with open(f"/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/mapPickles/{self.glider}_{glider_lon_mean:0.0f}_{glider_lat_mean:0.0f}_inset", "rb") as fd:
                ...
                with open(f"/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/mapPickles/{self.glider}_{glider_lon_mean:0.0f}_{glider_lat_mean:0.0f}_inset", "wb") as fd:
            ...
            if self.data_dir == "/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/data/processed/":
                plt.savefig(f"/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/images/toSend/{self.glider}_{var}_ts_panel_full_time_series.png")
            else:
                plt.savefig(f"/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/images/toSend/{self.glider}_{var}_ts_panel_{self.date}.png")
            # plt.show()
    ...
    def makeSegmentedDf(self):
        ...
        self.df = self.df.query("dive_bool > 0") #self.df.loc[self.df.dive_bool > 0]
        print(self.df)
    
    def moveDataFilesToProcessed(self):
        prev_calls = os.listdir('/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/data/processed/')
        prev_calls.remove('.DS_Store')

        for file in os.listdir("/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/data/new_data"):
            os.rename(f"/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/data/new_data/{file}", f"/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/data/processed/{file}")
    ...
    def reset(self):
        ...
        self._data = {"dive":{"w":[], "pitch":[], "roll":[], "dt":[], "amphr":[], "vac":[]},
                      "climb":{"w":[], "pitch":[], "roll":[], "dt":[], "amphr":[], "vac":[]}} # {"key" : {"sub_key" : [list of values, e.g., roll]}}      
        self.data_dir = "/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/data/processed/"  
    ...
    def sendEmail(self):
        image_dir = "/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/images/toSend/"
    ...
    def moveImages(self):
        im_dirs = os.listdir("/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/images/")
        if "sent" not in im_dirs: os.mkdir("/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/images/sent/")
        ims_to_move = os.listdir('/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/images/toSend/')
        ims_to_move.remove('.DS_Store')

        for file in ims_to_move:
            os.rename(f"/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/images/toSend/{file}", f"/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/images/sent/{file}")
    
    def packageTimeSeries(Self):
        if "timeseries" not in os.listdir("/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/images/"):
            os.mkdir(f"/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/images/timeseries/")

        for file in os.listdir("/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/images/toSend/"):
            if "time" in file:
                os.rename("/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/images/toSend/"+ file, "/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/images/timeseries/" + file)

        with zipfile.ZipFile('/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/images/timeseries.zip', 'w', zipfile.ZIP_DEFLATED, allowZip64=True) as zipf:
            zipdir('/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/images/timeseries/', zipf)

        for file in os.listdir("/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/images/timeseries/"): os.remove("/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/images/timeseries/"+file)
        os.removedirs("/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/images/timeseries/")
        os.rename("/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/images/timeseries.zip", "/Users/cflaim/Documents/GitHub/slocumRtDataVisTool/images/toSend/timeseries.zip")
